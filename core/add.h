...
// This is an oddity due to the way that the sign of zero is generated.
 ...
 template <class t>
   ...
   */
   ...
   sbv additionResultLowerBound(min.extend(1));
   sbv additionResultUpperBound(max.extend(1).increment());
   POSTCONDITION(additionResult.wellFormed(additionResultLowerBound, additionResultUpperBound));
